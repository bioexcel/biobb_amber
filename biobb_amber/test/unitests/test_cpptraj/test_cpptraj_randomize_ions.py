...
from biobb_amber.cpptraj.cpptraj_randomize_ions import CpptrajRandomizeIons
...
class TestCpptrajRandomizeIons():
    ...
    def test_CpptrajRandomizeIons(self):
        returncode= CpptrajRandomizeIons(properties=self.properties, **self.paths).launch()
