...
```
    /bin/sh: 1: nab_build_dna_structure: not found
### I / O Arguments
...
sander_mdrun -h
```
    /bin/sh: 1: sander_mdrun: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
* **output_traj_path** (*string*): Output trajectory file. File type: output. [Sample file](https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/data/sander/md.x). Accepted formats: TRJ, CRD, MDCRD, X
...
leap_gen_top -h
```
    /bin/sh: 1: leap_gen_top: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
#### Command line
```python
leap_gen_top --config config_leap_gen_top.yml --input_pdb_path structure.pdb --input_lib_path ligand.lib --input_frcmod_path ligand.frcmod --output_pdb_path structure.leap.pdb --output_top_path structure.leap.top --output_crd_path structure.leap.crd
```
### JSON
...
#### Command line
```python
leap_gen_top --config config_leap_gen_top.json --input_pdb_path structure.pdb --input_lib_path ligand.lib --input_frcmod_path ligand.frcmod --output_pdb_path structure.leap.pdb --output_top_path structure.leap.top --output_crd_path structure.leap.crd
```
...
process_minout -h
```
    /bin/sh: 1: process_minout: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
process_mdout -h
```
    /bin/sh: 1: process_mdout: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
parmed_cpinutil -h
```
    /bin/sh: 1: parmed_cpinutil: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
leap_add_ions -h
```
    /bin/sh: 1: leap_add_ions: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
#### Command line
```python
leap_add_ions --config config_leap_add_ions.yml --input_pdb_path structure.pdb --input_lib_path ligand.lib --input_frcmod_path ligand.frcmod --output_pdb_path structure.ions.pdb --output_top_path structure.ions.top --output_crd_path structure.ions.crd
```
### JSON
...
#### Command line
```python
leap_add_ions --config config_leap_add_ions.json --input_pdb_path structure.pdb --input_lib_path ligand.lib --input_frcmod_path ligand.frcmod --output_pdb_path structure.ions.pdb --output_top_path structure.ions.top --output_crd_path structure.ions.crd
```
...
```
    /bin/sh: 1: leap_build_linear_structure: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
leap_solvate -h
```
    /bin/sh: 1: leap_solvate: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
#### Command line
```python
leap_solvate --config config_leap_solvate.yml --input_pdb_path structure.pdb --input_lib_path ligand.lib --input_frcmod_path ligand.frcmod --output_pdb_path structure.solv.pdb --output_top_path structure.solv.top --output_crd_path structure.solv.crd
```
### JSON
...
#### Command line
```python
leap_solvate --config config_leap_solvate.json --input_pdb_path structure.pdb --input_lib_path ligand.lib --input_frcmod_path ligand.frcmod --output_pdb_path structure.solv.pdb --output_top_path structure.solv.top --output_crd_path structure.solv.crd
```
...
amber_to_pdb -h
```
    /bin/sh: 1: amber_to_pdb: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: 1: cpptraj_randomize_ions: not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
