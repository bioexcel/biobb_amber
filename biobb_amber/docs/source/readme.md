...
* Installation:
        ...
        conda install -c bioconda "biobb_amber>=3.6.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_amber:3.6.1--pyhdfd78af_1


* Usage:


        docker run quay.io/biocontainers/biobb_amber:3.6.1--pyhdfd78af_1
